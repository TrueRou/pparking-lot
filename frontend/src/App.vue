      ...
      <el-header class="flush">
        <div style="display: flex; flex-wrap: wrap">
          <el-menu :default-active="ruleset" @select="(v: Ruleset) => (ruleset = v)" class="el-menu-demo"
            ...
            <el-menu-item :disabled="pending || forbiddenRuleset(mode as Mode, 'relax')"
              index="relax">relax</el-menu-item>
            <el-menu-item :disabled="pending || forbiddenRuleset(mode as Mode, 'autopilot')"
          ...
          <el-menu :default-active="mode" @select="(v: Mode) => (mode = v)" mode="horizontal" :ellipsis="false">
            ...
            <el-menu-item :disabled="pending || forbiddenMode(ruleset as Ruleset, 'taiko')"
              index="taiko">taiko</el-menu-item>
            <el-menu-item :disabled="pending || forbiddenMode(ruleset as Ruleset, 'fruits')"
              index="ctb">ctb</el-menu-item>
            <el-menu-item :disabled="pending || forbiddenMode(ruleset as Ruleset, 'mania')"
      ...
      <el-container class="flex-grow: 1">
        <el-aside width="fit-content">
          <div style="display: flex; flex-direction: column; height: 100%">
            <el-menu :default-active="filter" @select="(v: 'all' | 'user') => {
              filter = v
              tableData = []
            }" class="el-menu-demo" style="border: 0">
              ...
              <el-table-column prop="beatmap.title" label="Beatmap" fixed width="180">
                <template #default="scope">
                  <el-tooltip effect="dark" :content="'' + scope.row.beatmap.id" placement="top-start">
                    <div>
                      <el-image style="width: 160px; height: 40px" :src="'https://cdn.sayobot.cn:25225/beatmaps/' +
